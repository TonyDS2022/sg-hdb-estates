    ...
    payload = {
        "meta": {
            ...
            "sources": [
                ...
                ["Master Plan 2025 Planning Area Boundary", "Urban Redevelopment Authority via data.gov.sg",
                 "URA planning area + region, assigned by point-in-polygon"],
                ["Master Plan 2025 Land Use Layer", "Urban Redevelopment Authority via data.gov.sg",
                 "zoning group and gross plot ratio per parcel"],
            ],
        },
